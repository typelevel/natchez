...
lazy val examples = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.grpc" % "grpc-okhttp" % "1.83.0" // required for the OpenTelemetry exporter
    )
  )
...
lazy val docs = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.slf4j" % "slf4j-simple" % "2.0.18",
      "io.opentelemetry" % "opentelemetry-exporter-otlp" % "1.64.0", // for the opentelemetry example
      "io.opentelemetry.semconv" % "opentelemetry-semconv" % "1.43.0"
    ),
