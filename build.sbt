...
lazy val lightstepGrpc = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.grpc" % "grpc-netty" % "1.83.1",
      "io.netty" % "netty-tcnative-boringssl-static" % "2.0.82.Final"
    ),
...
lazy val examples = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.grpc" % "grpc-okhttp" % "1.83.1" // required for the OpenTelemetry exporter
    )
  )
...
lazy val docs = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.slf4j" % "slf4j-simple" % "2.0.18",
      "io.opentelemetry" % "opentelemetry-exporter-otlp" % "1.65.0", // for the opentelemetry example
      "io.opentelemetry.semconv" % "opentelemetry-semconv" % "1.43.0"
    ),
