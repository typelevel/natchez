...
lazy val datadog = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      "com.datadoghq" % "dd-trace-ot" % "1.41.0",
      "com.datadoghq" % "dd-trace-api" % "1.41.0"
    )
  )
...
lazy val examples = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.grpc" % "grpc-okhttp" % "1.65.1" // required for the OpenTelemetry exporter
    )
  )
...
lazy val docs = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.slf4j" % "slf4j-simple" % "2.0.16",
      "io.opentelemetry" % "opentelemetry-exporter-otlp" % "1.43.0", // for the opentelemetry example
      "io.opentelemetry.semconv" % "opentelemetry-semconv" % "1.22.0-alpha"
    ),
