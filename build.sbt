...
lazy val newrelic = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.newrelic.telemetry" % "telemetry-core" % "0.17.0",
      "com.newrelic.telemetry" % "telemetry-http-okhttp" % "0.17.0"
    )
  )
...
lazy val docs = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.slf4j" % "slf4j-simple" % "2.0.17",
      "io.opentelemetry" % "opentelemetry-exporter-otlp" % "1.52.0", // for the opentelemetry example
      "io.opentelemetry.semconv" % "opentelemetry-semconv" % "1.34.0"
    ),
