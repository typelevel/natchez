...
lazy val datadog = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      "com.datadoghq" % "dd-trace-ot" % "1.47.3",
      "com.datadoghq" % "dd-trace-api" % "1.47.3"
    )
  )
...
lazy val examples = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.opentelemetry.semconv" % "opentelemetry-semconv" % "1.31.0",
      "io.grpc" % "grpc-okhttp" % "1.71.0" // required for the OpenTelemetry exporter
    )
  )
...
lazy val docs = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.slf4j" % "slf4j-simple" % "2.0.17",
      "io.opentelemetry" % "opentelemetry-exporter-otlp" % "1.48.0", // for the opentelemetry example
      "io.opentelemetry.semconv" % "opentelemetry-semconv" % "1.31.0"
    ),
