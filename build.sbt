...
lazy val lightstepGrpc = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.netty" % "netty-tcnative-boringssl-static" % "2.0.76.Final"
    ),
...
lazy val examples = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.grpc" % "grpc-okhttp" % "1.80.0" // required for the OpenTelemetry exporter
    )
  )
...
lazy val docs = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.slf4j" % "slf4j-simple" % "2.0.17",
      "io.opentelemetry" % "opentelemetry-exporter-otlp" % "1.61.0", // for the opentelemetry example
      "io.opentelemetry.semconv" % "opentelemetry-semconv" % "1.40.0"
    ),
